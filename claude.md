...
npx ccusage@latest 下载查看使用量，

ultrathink，请你认真深入思考，仔细分析，
注意代码编程规范，代码类型强安全，函数和 api 要有返回值，最小化原子修改，使用 npm run check 来检查你的代码问题
